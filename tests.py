class TestBooksCollector:
    ...
    def test_get_books_for_children_get_books_for_kids(self, books_collector):
        books_collector.add_new_book('Сказки')
        books_collector.set_book_genre('Сказки', 'Мультфильмы')
    ...
    def test_delete_book_from_favorites_delete_from_favorites(self, books_collector, books_collector_with_favorite):
        ...
        assert 'Сияние' not in books_collector.favorites
    '''
